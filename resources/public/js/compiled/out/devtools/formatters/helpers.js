...
var G__25738 = devtools.prefs.pref.call(null,v);
v = G__25738;
continue;
} else {
return v;
...
}catch (e25741){var _e__24787__auto__ = e25741;
return false;
}})();
...
}catch (e25745){var _e__24787__auto__ = e25745;
return false;
}})();
...
}catch (e25747){var _e__24787__auto__ = e25747;
return false;
}}
}
});
...
var vec__25749 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25749,(0),null);
var name = cljs.core.nth.call(null,vec__25749,(1),null);
...
return cljs.core.some.call(null,(function (p1__25752_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25752_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1544505237395
