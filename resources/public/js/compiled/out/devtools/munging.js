...
var o25636 = temp__4655__auto__;
var temp__4655__auto____$1 = (o25636["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o25637 = temp__4655__auto____$1;
return (o25637["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24780__auto__ = f;
return (o__24780__auto__["toString"]).call(o__24780__auto__);
} else {
return "";
}
}catch (e25638){var _ = e25638;
return "";
}});
...
try{var o__24780__auto___25640 = t;
(o__24780__auto___25640["cljs$lang$ctorPrWriter"]).call(o__24780__auto___25640,t,writer);
}catch (e25639){var __25641 = e25639;
}
...
var char_code = (function (){var o__24780__auto__ = (new String(char$));
return (o__24780__auto__["charCodeAt"]).call(o__24780__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24780__auto__ = String;
return (o__24780__auto__["fromCharCode"]).call(o__24780__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25642 = num_code;
switch (G__25642) {
case (1):
return (185);
...
var o__24780__auto__ = String;
return (o__24780__auto__["fromCharCode"]).call(o__24780__auto__,superscript_code);
});
/**
...
}catch (e25644){var _e__24787__auto__ = e25644;
return false;
}})())){
...
var vec__25645 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25645,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o25648 = temp__4655__auto__;
var temp__4655__auto____$1 = (o25648["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o25649 = temp__4655__auto____$1;
return (o25649["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25652){
var vec__25653 = p__25652;
var ns_detector = cljs.core.nth.call(null,vec__25653,(0),null);
...
var G__25659 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25660 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25659;
remaining_tokens = G__25660;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25650){
var G__25651 = cljs.core.first.call(null,seq25650);
var seq25650__$1 = cljs.core.next.call(null,seq25650);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25651,seq25650__$1);
});
...
var vec__25664 = cljs.core.split_with.call(null,(function (p1__25663_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25663_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25664,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25664,(1),null);
...
var vec__25667 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25667,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25667,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25670 = cljs.core.rest.call(null,remaining_tokens);
var G__25671 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25670;
name_tokens = G__25671;
continue;
} else {
...
var vec__25674 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25674,(0),null);
var arity = cljs.core.nth.call(null,vec__25674,(1),null);
var vec__25677 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25677,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25677,(1),null);
var vec__25680 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25680,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25680,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25680,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25680,(3),null);
...
var vec__25686 = result;
var munged_ns = cljs.core.nth.call(null,vec__25686,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25686,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25686,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25686,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25686,(4),null);
var arity = cljs.core.nth.call(null,vec__25686,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__25690 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__25690,(0),null);
var args = cljs.core.nth.call(null,vec__25690,(1),null);
var vec__25693 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25693,(0),null);
var name = cljs.core.nth.call(null,vec__25693,(1),null);
...
var G__25696 = (arity + (1));
var G__25697 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25698){
var vec__25699 = p__25698;
var arity = cljs.core.nth.call(null,vec__25699,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25699,(1),null);
...
return cljs.core.get.call(null,arities,p1__25702_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25703_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25706){
var vec__25707 = p__25706;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25707,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25704){
var G__25705 = cljs.core.first.call(null,seq25704);
var seq25704__$1 = cljs.core.next.call(null,seq25704);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25705,seq25704__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25715__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25715__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25715__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25715__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25716 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25716,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25716,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25716,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25716,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25716,(4),null);
var arity = cljs.core.nth.call(null,vec__25716,(5),null);
...
var o__24780__auto__ = f;
return (o__24780__auto__["getBasis"]).call(o__24780__auto__);
});
/**
...
}catch (e25720){var _e__24787__auto__ = e25720;
...
var G__25721 = (obj[cljs.core.first.call(null,path)]);
var G__25722 = cljs.core.rest.call(null,path);
obj = G__25721;
path = G__25722;
continue;
} else {
...
return (function (accum,p__25723){
var vec__25724 = p__25723;
var bit = cljs.core.nth.call(null,vec__25724,(0),null);
var protocol = cljs.core.nth.call(null,vec__25724,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25727){
...
var selector = cljs.core.nth.call(null,vec__25728,(2),null);
...
return (function (p__25732){
var vec__25733 = p__25732;
var munged_name = cljs.core.nth.call(null,vec__25733,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25733,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25733,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25731_SHARP_){
return (obj[cljs.core.first.call(null,p1__25731_SHARP_)]);
});})(name,sorted_matches,vec__25733,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1544505237224
