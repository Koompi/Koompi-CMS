...
return (new CustomEvent(event_name,(function (){var obj31013 = {"detail":data};
return obj31013;
})()));
} else {
...
var f = (function (){var pred__31020 = cljs.core._EQ_;
var expr__31021 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31020.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31021))){
return ((function (pred__31020,expr__31021){
return (function (p1__31014_SHARP_){
return console.warn(p1__31014_SHARP_);
});
;})(pred__31020,expr__31021))
} else {
if(cljs.core.truth_(pred__31020.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31021))){
return ((function (pred__31020,expr__31021){
return (function (p1__31015_SHARP_){
return console.debug(p1__31015_SHARP_);
});
;})(pred__31020,expr__31021))
} else {
if(cljs.core.truth_(pred__31020.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31021))){
return ((function (pred__31020,expr__31021){
return (function (p1__31016_SHARP_){
return console.error(p1__31016_SHARP_);
});
;})(pred__31020,expr__31021))
} else {
return ((function (pred__31020,expr__31021){
return (function (p1__31017_SHARP_){
return console.log(p1__31017_SHARP_);
});
;})(pred__31020,expr__31021))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31024){
...
var eval_fn = cljs.core.get.call(null,map__31025__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31027_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31029,(0),null);
...
}catch (e31034){if((e31034 instanceof Error)){
var e = e31034;
return not_found;
} else {
throw e31034;
...
//# sourceMappingURL=utils.js.map?rel=1544505249452
