...
var G__27602 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27602;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27603 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27603,ch);
...
if(("\\" === ch__$1)){
var ch_27604__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27604__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27604__$2);
} else {
}

var G__27605 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27605;
continue;
}
}
...
var vec__27613 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27613,(0),null);
var start_column = cljs.core.nth.call(null,vec__27613,(1),null);
...
var G__27616 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27616;
continue;
}
}
...
var _STAR_read_delim_STAR_27617 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_27617;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27618 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27618,(0),null);
var start_column = cljs.core.nth.call(null,vec__27618,(1),null);
...
var vec__27621 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27621,(0),null);
var end_column = cljs.core.nth.call(null,vec__27621,(1),null);
...
var vec__27624 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27624,(0),null);
var start_column = cljs.core.nth.call(null,vec__27624,(1),null);
...
var vec__27627 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27627,(0),null);
var end_column = cljs.core.nth.call(null,vec__27627,(1),null);
...
var vec__27630 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27630,(0),null);
var start_column = cljs.core.nth.call(null,vec__27630,(1),null);
...
var vec__27633 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27633,(0),null);
var end_column = cljs.core.nth.call(null,vec__27633,(1),null);
...
var G__27638 = (function (){var G__27637 = sb;
G__27637.append(ch);

return G__27637;
})();
var G__27639 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27638;
ch = G__27639;
continue;
}
...
switch (G__27642) {
case "\\":
var G__27646 = (function (){var G__27643 = sb;
G__27643.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27643;
})();
var G__27647 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27646;
ch = G__27647;
continue;
...
break;
default:
var G__27648 = (function (){var G__27644 = sb;
G__27644.append(ch);

return G__27644;
})();
var G__27649 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27648;
ch = G__27649;
continue;
...
var vec__27650 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27650,(0),null);
var end_column = cljs.core.nth.call(null,vec__27650,(1),null);
...
var vec__27653 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27653,(0),null);
var column = cljs.core.nth.call(null,vec__27653,(1),null);
...
var vec__27658 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27658,(0),null);
var column = cljs.core.nth.call(null,vec__27658,(1),null);
...
var vec__27663 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27663,(0),null);
var column = cljs.core.nth.call(null,vec__27663,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27668 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27668,(0),null);
var start_column = cljs.core.nth.call(null,vec__27668,(1),null);
...
var vec__27671 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27671,(0),null);
var end_column = cljs.core.nth.call(null,vec__27671,(1),null);
...
var G__27674 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27674,true,null,opts,pending_forms);
...
var G__27675 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27675)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27675)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27675)){
...
var _STAR_suppress_read_STAR_27676 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27676;
}});
...
var G__27677 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27677,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27677,rdr,first_line);
...
var G__27681 = matched;
var G__27682 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27681;
finished = G__27682;
continue;
} else {
...
var _STAR_suppress_read_STAR_27683 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27683;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env27684 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27685 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27685,"(");
...
var G__27686 = (i + (1));
var G__27687 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27684;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27688 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27688);
...
var G__27689 = cljs.core.next.call(null,s__$1);
var G__27690 = ret;
s__$1 = G__27689;
r = G__27690;
continue;
...
var G__27691 = cljs.core.next.call(null,s);
var G__27692 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27691;
key_vals = G__27692;
continue;
} else {
...
var gensym_env27696 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27696;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27697 = token;
var G__27697__$1 = (((G__27697 == null))?null:cljs.core.subs.call(null,G__27697,(1)));
var G__27697__$2 = (((G__27697__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27697__$1));
var G__27697__$3 = (((G__27697__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27697__$2));
var G__27697__$4 = (((G__27697__$3 == null))?null:cljs.core.symbol.call(null,G__27697__$3));
if((G__27697__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27697__$4);
}
})():(function (){var G__27698 = token;
var G__27698__$1 = (((G__27698 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27698));
if((G__27698__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27698__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27709,reader){
...
var eof = cljs.core.get.call(null,map__27710__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27716){
var G__27717 = cljs.core.first.call(null,seq27716);
var seq27716__$1 = cljs.core.next.call(null,seq27716);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27717,seq27716__$1);
});


//# sourceMappingURL=reader.js.map?rel=1544505244516
