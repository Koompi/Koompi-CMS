...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__23507 = cljs.core.instance_QMARK_;
var expr__23508 = reactive_val;
if(cljs.core.truth_(pred__23507.call(null,reagent.ratom.RAtom,expr__23508))){
return "ra";
} else {
if(cljs.core.truth_(pred__23507.call(null,reagent.ratom.RCursor,expr__23508))){
return "rc";
} else {
if(cljs.core.truth_(pred__23507.call(null,reagent.ratom.Reaction,expr__23508))){
return "rx";
} else {
if(cljs.core.truth_(pred__23507.call(null,reagent.ratom.Track,expr__23508))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1544505231989
